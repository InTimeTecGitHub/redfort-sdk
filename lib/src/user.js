...
var changepasswordFromAdminApi = '/admin/user/credential';
...
userManager.prototype = {
  ...
  changePasswordFromAdmin: function (token, userData, next) {
    var options = helper.getCertificateConfiguration(config);
    options.url = config.serviceBaseUrl + changepasswordFromAdminApi;
    options.method = 'PUT';
    options.headers = {Authorization: 'Bearer ' + token};
    options.json = userData;
